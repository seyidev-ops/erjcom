...
Content is data. Layout, head, nav, footer and SEO live in erjsite.py and
are identical for every page by construction.

v1.1 note: this file no longer generates cvscan.html or diagnose.html.
Those are now the REAL interactive tools, ported in by merge.py at
/cvscan/ and /diagnose/ — every link below points there instead.
"""
...
HOME = {
    ...
    "body": hero(
        ...
        btn("Find your leak &mdash; free", "diagnose/")
...
<section class="section section--line" id="model">
  <div class="wrap">
    ...
    <p class="mt-5" data-reveal><b>Most people patch the wrong one for months.</b>
      {tlink("Four questions tell you which is yours", "diagnose/")}</p>
  </div>
</section>
...
FREE = {
  ...
  <div class="wrap" style="max-width:calc(var(--measure) + 2 * var(--gutter))">
    ...
    {free_block("01", "Start here &middot; 90 seconds", "Find Your Leak",
      ...
      "Find my leak", "diagnose/", "facilitator-formal",
    ...
    {free_block("02", "Runs on your device", "The 10-Point CV Self-Scan",
      ...
      "Score my CV free", "cvscan/", "celebrating-offer",
...
STARTING = {
  ...
  <div class="wrap">
    <div style="max-width:var(--measure-text)" data-reveal>
      ...
      <p class="mt-4">Not sure where you are? {tlink("Find your leak first", "diagnose/")}</p>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="card mt-6" data-reveal style="border-left:3px solid var(--accent)">
      ...
      <div class="btns mt-5">{btn("Message us on WhatsApp", WA_ASK, blank=True)}
        {btn("Find your leak first", "diagnose/", ghost=True)}</div>
    </div>
  </div>
</section>
''',
...
NOTFOUND = {
  ...
  <div class="wrap">
    ...
    <div class="grid grid-3 mt-6" data-reveal-stagger>
      ...
      <a class="card" href="diagnose/"><h3>Find Your Leak</h3><p class="mt-2">Four questions, ninety seconds, free</p></a>
...
PAGES = [HOME, FREE, STARTING, MASTERY, GARJ, INNER,
